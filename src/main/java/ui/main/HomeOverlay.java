...
import ui.components.EventHomeOverlay;
import ui.components.HeaderButton;
...
public class HomeOverlay extends JWindow {
    ...
    public class PanelOverlay extends JPanel{
        ...
        private void init() {
            ...
            loginAnimator = new Animator(500, new Animator.TimingTarget() {
                ...
                public void timingEvent(float v) {
                    ...
                    int x = (int) ((450 + 180) * f);
                    migLayout.setComponentConstraints(panelLogin, "pos 100%-" + x + " 0.5al, w 450");
                    revalidate();
                }
            });
        ...
        private void createHeader(){
            ...
            JLabel title = new JLabel("Nhóm 08");
            title.setFont(new Font("Bodoni MT Black", Font.PLAIN, 40));
//            title.putClientProperty(FlatClientProperties.STYLE,"" + "font: bold +20");
        ...
        private void createLogin() {
            ...
            add(panelLogin, "pos 100% 0.5al,w 450");
        }
